...
- [x] 3.4 production buildとSWA CLIで、`/api/templates`、SPA直接アクセス、template選択から完成・保存・共有までの製品経路を確認する。
...
- [x] 5.4 `docs/development-roadmap.md`のフェーズ6状態と次の作業を更新し、全品質検査、Bicep検査、OpenSpec validation、実環境・実機確認の結果を記録する。
