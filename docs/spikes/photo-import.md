...
- [ ] 4エリアを確定後、一つのエリアを置換中に同じ操作を行い、未確定時との差を確認する。
- [ ] SafariとChromeの両方で30秒以上操作し、クラッシュ、入力遅延の蓄積、古い合成結果の再表示がないことを確認する。

暫定結果として、描画要求集約と静的レイヤーキャッシュの導入後は4096px・12MP候補ですでに明確な引っ掛かりがなくなり、2160px候補も滑らかに操作できた。確認した範囲では引っ掛かりの蓄積やクラッシュも発生していない。変更前は両候補で同程度に引っ掛かっていたため、保持解像度よりもpointerイベントごとの過剰描画と確定済みレイヤーの再合成が主因だったと判断する。ブラウザ別結果と4エリア確定後の条件は、追加確認後に下表へ分けて記録する。

| ブラウザ | 正規化候補 | 確定済みエリア数 | 最初のpinch | pinch直後のpan | 継続pan | 30秒以上の安定性・メモ |
| --- | --- | ---: | --- | --- | --- | --- |
| Safari | 4096px・12MP | 0 / 4 | 未確認 | 未確認 | 未確認 | 未確認 |
| Safari | 2160px | 0 / 4 | 未確認 | 未確認 | 未確認 | 未確認 |
| Safari | 比較に使った候補 | 4 / 4 | 未確認 | 未確認 | 未確認 | 未確認 |
| Chrome | 4096px・12MP | 0 / 4 | 未確認 | 未確認 | 未確認 | 未確認 |
| Chrome | 2160px | 0 / 4 | 未確認 | 未確認 | 未確認 | 未確認 |
| Chrome | 比較に使った候補 | 4 / 4 | 未確認 | 未確認 | 未確認 | 未確認 |
